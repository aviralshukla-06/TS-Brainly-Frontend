...
export function EditContent({ open, onClose }) {
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <span className="bg-[#101624] rounded p-4 h-96 w-80">
                        ...
                        <div className="flex justify-center mt-8">
                            <button onClick={editContent} className="flex items-center justify-center w-24 px-4 py-2 text-white bg-blue-500 rounded">
                                Submit
                            </button>
                        </div>
